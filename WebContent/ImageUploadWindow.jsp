<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
   pageEncoding="ISO-8859-1" import="com.assignment.model.ImageInfo"%>
<%@ page import="com.assignment.functions.DatabaseFunctions"%>
	...
	<table border="1" align="center" width="900px">
		...
		<tr>
			...
			<table border="1" align="center" width="900px">
				...
				<%
				DatabaseFunctions fb = new DatabaseFunctions();
				...
				<tr>
					...
					<td><a href="delete?id=<%=img.getImageId()%>">
						...
						<a href="EditWindow.jsp?id=<%=img.getImageId()%>&oldName=<%=img.getName()%>">
							<button
								type="button">Edit
							</button>
						</a>
